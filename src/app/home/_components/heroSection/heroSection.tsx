export default function HeroSection() {
  return (
    <section className="bg-black text-white flex flex-col items-center justify-center min-h-screen px-6 py-12 text-center">
      {/* Big Title */}
      <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold leading-snug md:leading-tight">
        Crafting <span className="text-white">Responsive</span> Modern
        <br className="hidden sm:block" />  Web Apps<span className="text-white"> With React & Next.JS</span>
      </h1>
